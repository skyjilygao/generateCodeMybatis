 ...
 * @since 20181106
 */
public class BatchInsertByMultiSqlMethodGeneratorJavaMapper extends AbstractJavaMapperMethodGenerator {
    private String methodName;

    public BatchInsertByMultiSqlMethodGeneratorJavaMapper(String methodName) {
        super();
