 ...
 * @since 20181106
 */
public class BatchInsertByMultiSqlMethodGeneratorXmlMapper extends AbstractXmlElementGenerator {
    private String methodName;

    public BatchInsertByMultiSqlMethodGeneratorXmlMapper(String methodName) {
        super();
...
//    </foreach>
        ...
        foreachElm.addElement(this.getBaseColumnListElement());
